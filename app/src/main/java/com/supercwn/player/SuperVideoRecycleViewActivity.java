...
public class SuperVideoRecycleViewActivity extends Activity {
    ...
    private void initAdapter() {
        ...
        mAdapter.setPlayClick(new SuperVideoAdapter.onPlayClick() {
            ...
            public void onPlayclick(int position, RelativeLayout image) {
                ...
                if (dataList.get(position).isLive())
    ...
    private List<VideoListBean> setData() {
        dataList.clear();
        VideoListBean bean12 = new VideoListBean();
        bean12.setVideoUrl("http://ivi.bupt.edu.cn/hls/cctv1hd.m3u8");
        bean12.setLive(true);
        dataList.add(bean12);

        VideoListBean bean13 = new VideoListBean();
        bean13.setVideoUrl("http://ivi.bupt.edu.cn/hls/cctv3hd.m3u8");
        bean13.setLive(true);
        dataList.add(bean13);
        VideoListBean bean14 = new VideoListBean();
        bean14.setVideoUrl("http://ivi.bupt.edu.cn/hls/cctv5hd.m3u8");
        bean14.setLive(true);
        dataList.add(bean14);
        VideoListBean bean15 = new VideoListBean();
        bean15.setLive(true);
        bean15.setVideoUrl("http://ivi.bupt.edu.cn/hls/cctv5phd.m3u8");
        dataList.add(bean15);


        VideoListBean bean16 = new VideoListBean();
        bean16.setLive(true);
        bean16.setVideoUrl("http://ivi.bupt.edu.cn/hls/cctv6hd.m3u8");
        dataList.add(bean16);

        VideoListBean bean1 = new VideoListBean();
        bean1.setVideoUrl("http://ivi.bupt.edu.cn/hls/cctv5phd.m3u8");
        dataList.add(bean1);
        ...
        dataList.add(bean10);
        VideoListBean bean11 = new VideoListBean();
        bean11.setVideoUrl("http://live.hkstv.hk.lxdns.com/live/hks/playlist.m3u8");
        dataList.add(bean11);
